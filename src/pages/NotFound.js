      ...
      <div className="header">
        <Container>
          ...
          <div className="sidebar-header">
            <Link to="/" className="sidebar-logo"><img src={gyloopSidebar} alt="" className="logoGyloopSidebar"/></Link>
          </div>
        ...
        <Container>
          <Row className="gx-5">
            <Col lg="5" className="d-flex flex-column align-items-center">
              ...
              <Link to="/dashboard/sales" className="btn btn-primary btn-error">Back to Home</Link>
            </Col>
